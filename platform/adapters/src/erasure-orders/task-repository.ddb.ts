 ...
 * TaskRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Task repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { TaskRepository } from "@erasuremesh/services/erasure-orders";
...
/**
 * TaskRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ERASURE_TASK
 * Entity Token: ERASURE_TASK
 * SK Prefix: ERASURE_TASK
 */
export class TaskRepositoryDdb implements TaskRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ERASURE_TASK";
  private readonly ENTITY_TOKEN = "ERASURE_TASK";
  private readonly SK_PREFIX = "ERASURE_TASK";
  ...
  private readonly ENTITY_TYPE_PK = "ERASURE_TASKS";
