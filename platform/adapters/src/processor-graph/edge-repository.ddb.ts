/**
 * EdgeRepository - DynamoDB Implementation
 *
 ...
 * EdgeRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Edge repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { EdgeRepository } from "@erasuremesh/services/processor-graph";
...
/**
 * EdgeRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: GRAPH_EDGE
 * Entity Token: GRAPH_EDGE
 * SK Prefix: GRAPH_EDGE
 */
export class EdgeRepositoryDdb implements EdgeRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "GRAPH_EDGE";
  private readonly ENTITY_TOKEN = "GRAPH_EDGE";
  private readonly SK_PREFIX = "GRAPH_EDGE";
  ...
  private readonly ENTITY_TYPE_PK = "GRAPH_EDGES";
