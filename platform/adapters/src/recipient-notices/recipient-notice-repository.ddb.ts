 ...
 *
 * DDD: Infrastructure adapter implementing RecipientNotice repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { RecipientNoticeRepository } from "@erasuremesh/services/recipient-notices";
...
/**
 * RecipientNoticeRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: RECIPIENT_NOTICE
 * Entity Token: RECIPIENT_NOTICE
 * SK Prefix: RECIPIENT_NOTICE
 */
export class RecipientNoticeRepositoryDdb implements RecipientNoticeRepository {
  ...
  private readonly ENTITY_TYPE = "RECIPIENT_NOTICE";
  private readonly ENTITY_TOKEN = "RECIPIENT_NOTICE";
  private readonly SK_PREFIX = "RECIPIENT_NOTICE";
  ...
  private readonly DOMAIN = "RECIPIENT_NOTICES";
  private readonly ENTITY_TYPE_PK = "RECIPIENT_NOTICES";
  private generateCorrelationId(): string {
    const domainPrefix = "rcn";
