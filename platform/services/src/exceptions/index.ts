/**
 * Exceptions Services - Application Layer Export
 *
...
/**
 * Exceptions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for exceptions domain.
 */
